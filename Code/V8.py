...
# F=combustible, C=control rod, A=aire, O=canal irradiación, W=agua/reflector
lattice_map = [
  ['W','W','W','W','W','W','W','W','W'],          # r0
  ['W','F','F','F','F','F','W','W','W'],          # r1
  ['W','F','F','F','F','F','F','W','W'],          # r2
  ['W','A','C','F','F','F','F','F','W'],          # r3  (aire en c1, CR en c2)
...
# Mapa directo a universos — ¡CR completo para el plot!
char_to_univ = {
    'F': pin_fuel_univ,
...
# Zoom del núcleo (donde verás CR negras y el tubo de aire)
p_zoom = openmc.Plot()
p_zoom.basis    = 'xy'
...
# Vista completa de la piscina (opcional, útil para contexto)
p_full = openmc.Plot()
p_full.basis    = 'xy'
